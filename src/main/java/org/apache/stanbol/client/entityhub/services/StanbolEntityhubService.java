 ...
 */
package org.apache.stanbol.client.entityhub.services;
...
public interface StanbolEntityhubService extends StanbolService
{
    ...
    /**
     * Get an entity managed by the Local EntityHub
     * 
    ...
    /**
     * Create entities for the EntityHub. If any of such Entities already exists within the Entityhub and the update parameter
     * is false, a {@link StanbolServiceException} will be thrown
     * 
     ...
     *            referenced entity will be created or updated
     * @param update If true, entities that already exist will be updated
     * @return String of the created Entity
     * @throws StanbolServiceException
     */
    ...
    /*
    public Map<String, List<String>> query(List<String> selected, List<QueryConstraint> constraints, LDPathProgram ldpath, int limit, int offset);
    
    public Map<String, List<String>> query(String site, List<String> selected, List<QueryConstraint> constraints, LDPathProgram ldpath, int limit, int offset);
    */
