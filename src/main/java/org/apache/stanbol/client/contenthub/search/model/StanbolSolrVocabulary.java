...
/**
 * Vocabulary class which provides constant properties to be used in the communication with Solr. Most of these
 * properties point to the fields defined in the <b>schema.xml</b> of Solr.
 * 
 * @author anil.sinaci
 * 
 */
public class StanbolSolrVocabulary
{
    ...
    public enum SolrFieldName
    {
        ...
        /**
         * Name of the field which holds the countries of the cities mentioned in the content. This field is populated
         * by the semantic operations through the enhancements of the content.
         */
        COUNTRIES(STANBOLRESERVED_PREFIX + "countries"),

        /**
         * Name of the field which holds the image captions of the entities mentioned in the content. This field is
        ...
        /**
         * Name of the field which holds the geographic regions of the cities mentioned in the content. This field is
         * populated by the semantic operations through the enhancements of the content.
         */
        REGIONS(STANBOLRESERVED_PREFIX + "regions"),

        /**
         * Name of the field which holds the governors of the provinces mentioned in the content. This field is
         * populated by the semantic operations through the enhancements of the content.
         */
        GOVERNORS(STANBOLRESERVED_PREFIX + "governors"),

        /**
         * Name of the field which holds the capital cities of the countries mentioned in the content. This field is
         * populated by the semantic operations through the enhancements of the content.
         */
        CAPITALS(STANBOLRESERVED_PREFIX + "capitals"),

        /**
         * Name of the field which holds the largest cities of the entities mentioned in the content. This field is
         * populated by the semantic operations through the enhancements of the content.
         */
        LARGESTCITIES(STANBOLRESERVED_PREFIX + "largestcities"),

        /**
         * Name of the field which holds the names of the leaders of the countries mentioned in the content. This field
        ...
        /**
         * Name of the field which holds the given names of the persons mentioned in the content. This field is
         * populated by the semantic operations through the enhancements of the content.
         */
        GIVENNAMES(STANBOLRESERVED_PREFIX + "givennames"),

        /**
         * Name of the field which holds the important events which are known/invented through the persons mentioned in
         * the content. This field is populated by the semantic operations through the enhancements of the content.
         */
        KNOWNFORS(STANBOLRESERVED_PREFIX + "knownfors"),

        /**
         * Name of the field which holds the birthplaces/placeofbirths of the persons mentioned in the content. This
         * field is populated by the semantic operations through the enhancements of the content.
         */
        BIRTHPLACES(STANBOLRESERVED_PREFIX + "birthplaces"), PLACEOFBIRTHS(STANBOLRESERVED_PREFIX + "placeofbirths"),

        /**
         * Name of the field which holds the names of the institutions at which the persons mentioned in the content
         * worked. This field is populated by the semantic operations through the enhancements of the content.
         */
        WORKINSTITUTIONS(STANBOLRESERVED_PREFIX + "workinstitutions"),

        /**
         * Name of the field which holds the captions of the images belonging to the persons mentioned in the content.
        ...
        /**
         * Name of the field which holds the short descriptions of the persons mentioned in the content. This field is
         * populated by the semantic operations through the enhancements of the content.
         */
        SHORTDESCRIPTIONS(STANBOLRESERVED_PREFIX + "shortdescriptions"),

        /**
         * Name of the field which holds the fields on which the persons mentioned in the content studied. This field is
         * populated by the semantic operations through the enhancements of the content.
         */
        ...
        public static SolrFieldName[] getSemanticFieldNames()
        {
            SolrFieldName[] semanticFieldNames = { COUNTRIES, IMAGECAPTIONS, REGIONS, GOVERNORS, CAPITALS,
                    LARGESTCITIES, LEADERNAMES, GIVENNAMES, KNOWNFORS, BIRTHPLACES, PLACEOFBIRTHS, WORKINSTITUTIONS,
                    CAPTIONS, SHORTDESCRIPTIONS, FIELDS };
    ...
    /**
     * Ending characters for dynamic fields of {@link String} type. The type of this field is "string" in the Solr
     * schema.
     */
    public static final String SOLR_DYNAMIC_FIELD_TEXT = "_t";

    /**
     * Ending characters for dynamic fields of {@link String} type. This field is indexed with "text_ws" type to
     * tokenize the values and enable case insensitive search on the field. Although "*_t" are copied to
     * stanbolreserved_text_all, this field enables the search only on this field through Solr interface.
     */
    ...
    /**
     * Checks whether the specified field is excluded or not i.e whether the field will be presented as a facet or not
     * 
    ...
    /**
     * Checks whether the specified type is a range type or not i.e whether the field will be used in range queries or
     * not
     * 
     * @param name field name
     */
    ...
    /**
     * Types that will be used in range queries and will not be escaped in {@link SolrSearchEngineHelper} class
     */
