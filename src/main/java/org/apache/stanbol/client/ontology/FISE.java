...
public class FISE
{
    ...
    public static final Property USER_METADATA = new PropertyImpl(FISE_URI + "user-metadata");
    public static final Property USER_METADATA_VALUE = new PropertyImpl(FISE_URI + "user-metadata-value");
    public static final Resource USER_METADATA_ANNOTATION = new ResourceImpl(FISE_URI, "UserMetadataAnnotation");
